...
#create kable table
summary_table <- kable(summary.table, caption = "Blue Mesa Reservoir Summary Statistics", col.names = c("Variable", "Mean", "Minimum", "Maximum", "Standard Deviation"), "pipe")
summary_table
