...
```{r}
getwd()
setwd("C:/Users/cassi/OneDrive - Duke University/Documents/School/Grad School/Spring 2022/Environmental Data Analytics/KinserOwensWhite_ENV872_EDA_FinalProject/")
```
...
ggplot(all.data, aes(x="El"))    
```

###ADD

---
title: "FinalProject TS DRaft"
